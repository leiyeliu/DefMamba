...
if __name__ == "__main__":
    ...
    # mmdet_flops(f"{mmdet_path}/configs/defm/mask_rcnn_defm-s_fpn_coco_small.py") # 42.4M 285883020640.0
    ...
    mmseg_flops(f"{mmseg_path}/configs/defm/upernet_ms_defm_4xb4-160k_ade20k-512x512_small.py") # Flops: 963853165152.0   Params: 54546956
